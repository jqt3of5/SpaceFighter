...
//     version 1.7.0
//     from Assets/SpaceFighter 1.inputactions
//
...
public partial class @SpaceFighter1: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @SpaceFighter1()
    {
    ...
    {
        private @SpaceFighter1 m_Wrapper;
        public ShipManeuverActions(@SpaceFighter1 wrapper) { m_Wrapper = wrapper; }
